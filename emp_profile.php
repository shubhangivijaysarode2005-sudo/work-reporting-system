...
if(isset($_POST['work_btn'])){
 ...
 $check="SELECT * FROM work_table WHERE employee_id='$id' AND work_date='$date'";
 ...
 if ($rows){
  ...
  $insert="INSERT INTO work_table(employee_id,work_desc,work_date)VALUES('$id','$work_desc','$date')";
 $query=mysqli_query($con,$insert);
 if($query){
  $_SESSION['msg']="<small>  Work Submitted Sucessfully!</small>";
  header("location:emp_profile.php");
 }
 else{
