...
// 🔴 MOVE DELETE LOGIC HERE (before any output)
if (isset($_POST['User_delete'])){
  $emp_id=$_POST['user_id'];
  $delete="DELETE FROM user_table WHERE id='$emp_id'";
  ...
  <table class="table table-hover bg-white table-sm">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="d-flex"> 
          <span><a href="profile.php?id=<?= $result['id'] ?>"><i class="bi bi-eye-fill text-success mx-1"></i></a></span> 
          ...
          <form action="" method="POST" onsubmit="return confirm('Are you sure you want to delete?')">
            ...
            <button class="p-0 border-0 bg-light" name="User_delete">
              <i class="bi bi-trash3-fill text-danger mx-1"></i>
            </button>
          </form>
        </td>
      </tr>
